  ...
  const timelineEvents = [
    {
      ...
      description: "Establecida durante la Primera Cruzada por Godofredo de Bouillón en Jerusalén."
    },
    {
      year: "1847", 
      title: "Reconstitución Pontificia",
      description: "El Papa Pío IX reconstituye la Orden como institución pontificia moderna."
    },
    {
      year: "1949",
      title: "Estatutos Modernos",
      description: "El Papa Pío XII aprueba los nuevos estatutos que rigen la Orden actualmente."
    },
    {
      year: "1962",
      title: "Lugartenencia Argentina",
      description: "Se establece oficialmente la Lugartenencia Argentina de la Orden."
    },
    {
      year: "1988",
      title: "Constitución Apostólica",
      description: "Juan Pablo II publica la Constitución Apostólica que define la estructura actual."
    },
    {
      year: "Presente",
      title: "Misión Continua",
      description: "La Orden mantiene su compromiso con Tierra Santa y las comunidades cristianas."
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Más de nueve siglos de tradición al servicio de la Iglesia y Tierra Santa
            </p>
          </div>
            ...
            <div className="space-y-16">
              {timelineEvents.map((event, index) => (
                <div key={index} className={`flex items-center ${index % 2 === 0 ? 'justify-start' : 'justify-end'}`}>
                  ...
                  {/* Central Circle */}
                  <div className="absolute left-1/2 transform -translate-x-1/2 w-6 h-6 bg-gradient-gold rounded-full border-4 border-card shadow-gold"></div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="text-center mt-20">
            <blockquote className="font-serif text-2xl md:text-3xl italic text-primary max-w-3xl mx-auto">
              "Por la gracia de Dios, guardianes de los Santos Lugares y protectores de los cristianos de Tierra Santa"
            </blockquote>
